...
<div class="d-flex justify-content-center">
	<div class="w-50">
		<div class="m-5">
			<h1>글 상세/수정</h1>
			<input name="subject" type="text" class="form-control mb-2"
				placeholder="제목을 입력해주세요." value="${post.subject}">
			<textarea name="content" class="form-control mb-2" rows="15"
			...
			<div class="file-upload-btn clearfix">
				<input id="file" type="file" class="float-right"
			...
			<div class="btn-area clearfix mt-5">
				<button id="postDeleteBtn" data-post-id="${post.id}"
					class="btn btn-secondary float-left">삭제</button>

				<div class="float-right">
					<button id="postListBtn" class="btn btn-dark">목록</button>
					<%-- postId를 자바스크립트에서 사용하기 위해 data 속성을 추가한다. data-속성명 --%>
					<button id="saveBtn" data-post-id="${post.id}"
						class="btn btn-primary ml-2">저장</button>
				</div>
			</div>
		</div>
	</div>
